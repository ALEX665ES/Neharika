...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/ALEX665ES/Neharika",
)
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/AryanStudyGrpup")
